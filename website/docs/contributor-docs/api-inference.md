...
:::info[What are AWS API model files?]
...
:::info[Cross-account resource management]
The Owner AWS Account ID for a resource [may be different](https://aws-controllers-k8s.github.io/community/docs/user-docs/authorization/#create-resource-in-different-aws-accounts) from the
